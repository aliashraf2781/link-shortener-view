			...
			<div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-teal-600 via-teal-700 to-cyan-800 p-8 md:p-10 shadow-2xl">
				...
				<div className="relative flex items-center justify-between">
					<div>
						...
						<p className="text-teal-200 font-medium mt-2 text-lg">
			...
			{overviewLoading ? (
				...
				<>
					...
					{overview?.best_performing_link && (
						<div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-teal-50 via-cyan-50 to-emerald-50 border border-teal-200/40 p-8 shadow-sm">
							<div className="absolute -right-8 -top-8 h-32 w-32 rounded-full bg-teal-200/20 blur-3xl" />
							<div className="flex items-start justify-between gap-6">
								<div className="flex-1">
									<div className="flex items-center gap-3 mb-4">
										<div className="inline-flex items-center justify-center h-12 w-12 rounded-xl bg-linear-to-br from-teal-400 to-cyan-500 shadow-lg shadow-teal-500/25">
										...
										<div>
											...
											<p className="text-sm text-teal-600 font-medium">Top performing link</p>
										</div>
									</div>
									...
									<div className="flex items-center gap-6">
										<div className="bg-white/80 rounded-xl px-4 py-3 border border-teal-200/50">
								...
								<div className="hidden md:flex items-center justify-center h-20 w-20 opacity-10 rounded-full bg-linear-to-br from-teal-500 to-teal-600 text-4xl">
...
<div className="h-9 w-9 rounded-lg bg-linear-to-br from-teal-500 to-teal-600 flex items-center justify-center shadow-md shadow-teal-500/20">
					...
					<div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100 hover:shadow-lg transition-shadow">
						<div className="space-y-4">
							<h3 className="text-lg font-bold text-gray-900 flex items-center gap-3">
								<div className="h-9 w-9 rounded-lg bg-linear-to-br from-teal-500 to-cyan-600 flex items-center justify-center shadow-md shadow-teal-500/20">
							...
							<div className="grid grid-cols-3 gap-4 mb-6">
								{[
									{ label: "Peak", value: maxClicks, color: "from-emerald-500 to-emerald-600", bg: "bg-emerald-50", text: "text-emerald-700" },
										{ label: "Average", value: avgClicks, color: "from-teal-500 to-teal-600", bg: "bg-teal-50", text: "text-teal-700" },
										{ label: "Total", value: chartData.reduce((sum, d) => sum + d.clicks, 0), color: "from-cyan-500 to-cyan-600", bg: "bg-cyan-50", text: "text-cyan-700" },
								].map((item, idx) => (
...
<div className="h-10 w-10 animate-spin rounded-full border-4 border-teal-200 border-t-teal-600" />
									...
									<ResponsiveContainer width="100%" height={300}>
										...
										<YAxis stroke="#94a3b8" style={{ fontSize: "12px" }} />
										<Tooltip content={<CustomTooltip />} />
<Bar dataKey="clicks" fill="#ccfbf1" opacity={0.7} radius={[8, 8, 0, 0]} />
											<Line
												type="monotone"
												dataKey="clicks"
												stroke="#0d9488"
						...
						<div className="grid gap-6 lg:grid-cols-2">
							...
							<div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100 hover:shadow-lg transition-shadow">
								<h3 className="text-lg font-bold text-gray-900 flex items-center gap-3 mb-6">
									<div className="h-9 w-9 rounded-lg bg-linear-to-br from-cyan-500 to-teal-600 flex items-center justify-center shadow-md shadow-cyan-500/20">
							...
							<div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100 hover:shadow-lg transition-shadow">
								<h3 className="text-lg font-bold text-gray-900 flex items-center gap-3 mb-6">
									<div className="h-9 w-9 rounded-lg bg-linear-to-br from-teal-500 to-emerald-600 flex items-center justify-center shadow-md shadow-teal-500/20">
							...
							{recentLoading ? (
								...
								<div className="space-y-3">
									{recentClicks.slice(0, 10).map((click, idx) => {
										const colors = [
											{ bg: "bg-teal-50", icon: "from-teal-500 to-teal-600", ring: "ring-teal-100" },
											{ bg: "bg-emerald-50", icon: "from-emerald-500 to-teal-600", ring: "ring-emerald-100" },
											{ bg: "bg-cyan-50", icon: "from-cyan-500 to-cyan-600", ring: "ring-cyan-100" },
											{ bg: "bg-sky-50", icon: "from-sky-500 to-sky-600", ring: "ring-sky-100" },
											{ bg: "bg-green-50", icon: "from-green-500 to-emerald-600", ring: "ring-green-100" },
										];
